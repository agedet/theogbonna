          ...
          >
            ...
            <div>
              ...
              <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-slate-400 px-1">
                ...
                <span className="break-all text-amber-400">{email}</span>.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="divide-y divide-white/[0.06]">
              ...
              <div className="flex flex-col gap-2 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                ...
                <span className="inline-flex w-fit items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 text-xs font-medium text-emerald-400">
              ...
              {receiptUrl && (
                <div className="flex items-center justify-between px-4 py-3 sm:px-5">
                  ...
                  <a
                    ...
                    className="text-sm text-amber-400 underline underline-offset-2 transition-colors hover:text-amber-300"
                  >
                    View ↗
                  </a>
                </div>
